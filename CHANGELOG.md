...
The transition from Brim to Zui should preserve your data similar to upgrades
between prior Brim versions. An [article](https://zui.brimdata.io/docs/support/Brim-Zui-Transition)
provides details on cleanup you can do once you're running Zui.

### Other Changes

- Update Zed to [v1.6.0](https://github.com/brimdata/zed/releases/tag/v1.6.0)
- Update Brimcap to [v1.3.0](https://github.com/brimdata/brimcap/releases/tag/v1.3.0)
...
- Migrate user data from Brim to Zui (#2428)
